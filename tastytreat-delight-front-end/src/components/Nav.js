...
function Nav({ isLoggedIn, handleLogout, role }) {
  return (
    <Toolbar className="flex justify-between">
      <div className="space-x-4">
       ...
       {role==="Admin" &&  <Button color="inherit" component={Link} to="/your-treats" className="hover:text-gray-300">
          Your Treats
        </Button> }
        <Button color="inherit" component={Link} to="/product-catalog" className="hover:text-gray-300">
          Product Catalog
        </Button>
        <Button color="inherit" component={Link} to="/blogs" className="hover:text-gray-300">
          Blogs
        </Button>
